...
import com.generagames.happy.town.farm.wordandroid.net.models.responses.CardPayRespond
...
interface PayClient {
    ...
    suspend fun payCard(@Header("Authorization") token: String, @Body request: CardPayRequest): WaitCardPayRespond
    ...
    suspend fun waitExpirationDate(@Header("Authorization") token: String, @Query("dateCacheId") dateCacheId: String): CardPayRespond
}